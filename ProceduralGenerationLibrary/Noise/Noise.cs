...
public static class Noise
{
    ...
    private static float Dot(this Vector2 g, float x, float y)
    {
        return g.X * x + g.Y * y;
    }

    private static float Dot(this Vector3 g, float x, float y, float z)
    {
    ...
    private static readonly Lazy<float> Sqrt2 = new(()=>(float)Math.Sqrt(2f));
